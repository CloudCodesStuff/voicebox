...
const stages = [
  {
    ...
    d: "A button in the corner of your site, or your own button. Renders in a shadow root so your CSS and ours can never collide, under 30KB, loaded on idle, and it never blocks your page.",
  },
  {
    t: "Ingest validates",
