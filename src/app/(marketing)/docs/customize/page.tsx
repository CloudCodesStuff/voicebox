...
const options: Array<[string, string, string]> = [
  ...
  ["triggerLabel", "Feedback", "Text on the floating button, and its accessible name when icon-only."],
  ["triggerStyle", "icon-label", "icon-label · icon (a bubble) · label"],
  ["triggerIcon", "message", "message · star · lightbulb · heart · help"],
  ["triggerSize", "md", "sm (34px) · md (40px) · lg (48px)"],
  [
    "triggerOffset",
    "20",
    "Distance from the page edge in px, 0 to 160. Clears a chat bubble or cookie bar.",
  ],
  ["triggerHideOnMobile", "false", "Hide the button below 640px. Your own triggers still work."],
